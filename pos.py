...
if page == "View Dashboard":
    if st.session_state.uploaded_data is None:
        ...
        def header_style():
            return [
                "background-color: #4CAF50; color: white; font-weight: bold; font-size: 18px;"
        ...
        st.dataframe(
            ...
            height=600,  # Increased table height for better view
        )
        ...
        if not below_threshold.empty:
            st.dataframe(
                ...
                height=500,  # Adjusted table height for better visibility
            )
        else:
